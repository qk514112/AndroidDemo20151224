...
package com.example.dj0708.androiddemo20151224.custom;
...
public class CustomFragmentTabHost extends TabHost implements
	...
	static class SavedState extends BaseSavedState {
		 ...
		 * @param flags Addition flags about how the object should be written.
...
//		if (tabId.equals(MainActivity.TAG_MY_ACCOUNT)) {
//			if (!PjbApplication.USER_LOGINED_TAG
//					|| TextUtils.isEmpty(PjbApplication.ACCESS_TOKEN)) {
//				PjbApplication.UserRegistType = 1;
//				// 没登陆
//				mContext.startActivity(new Intent(mContext, LoginActivity.class));
//
//				if (mLastTab != null) {
//					this.setCurrentTabByTag(mLastTab.tag);
//				}
//				return ft;
//			}
//		}
